...
\newpage
\begin{center}
\includegraphics[width=0.8\textwidth]{images/cert_image_fc4f0a09.jpg}
\end{center}
...
\textbf{1} & \textbf{INTRODUCTION} & \\
 ...
 & 1.2~~Relevance of FullStack developer to Electronics and communications & \\
...
\begin{figure}[H]
\centering
\includegraphics[width=0.55\textwidth]{images/company_logo_6d3f0df9.png}
...
• Innovation • Quality and Reliability • Continuous Learning • Technical Excellence • Team Collaboration
...
• Designed frontend interface • Developed backend APIs • Integrated frontend and backend • Tested data flow and performance
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{images/ch_img_2a13007b.jpg}
\caption{temp}
\end{figure}
