...
\vspace{6pt}
\includegraphics[height=2.8cm]{images/vtu_logo.png}\par
\vspace{6pt}
...
% ==========================================================================
% TABLE OF CONTENTS — Custom table format matching template
% ==========================================================================
\newpage
\begin{center}
{\Large \textbf{TABLE OF CONTENTS}\par}
\end{center}
\addcontentsline{toc}{chapter}{Table of Contents}

\vspace{0.3cm}
\begin{tabular}{@{} p{1.8cm} p{10.5cm} r @{}}
...
\textbf{1} & \textbf{INTRODUCTION} & \\
 ...
 & 1.2~~Relevance of Full Stack Developer to Electronics and Communication Engineering & \\
 & 1.3~~Evolution of Practices in the Field & \\
 & 1.4~~Current Trends and Technologies & \\
\addlinespace[4pt]
\textbf{2} & \textbf{ORGANISATION PROFILE} & \\
 & 2.1~~Introduction & \\
 ...
 & 2.5~~Core Values & \\
\addlinespace[4pt]
\textbf{3} & \textbf{WORK DONE / METHODOLOGY} & \\
...
\addlinespace[4pt]
\textbf{4} & \textbf{RESULTS AND DISCUSSION} & \\
